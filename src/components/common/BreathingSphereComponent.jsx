    ...
    return (
        <>
            <div className="hero-title-wrapper">
                <img src="/hero-text.png" alt="" className={`hero-title px-10 absolute left-1/2 -translate-x-1/2 w-full max-w-[700px] h-auto ${hidden ? "hero-hidden-by-button" : ""}`} />
            </div>
            ...
            <div className="sphere-disintegration-wrapper relative my-20">
                ...
                <button className="discover-btn" onClick={handleDisintegration}>
                    Scopri di più ↓
                </button>
            </div>
        </>
