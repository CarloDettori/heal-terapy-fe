        ...
        <div className="box">
            ...
            <WhiteCard customClass="flex-row lg:flex lg:gap-5">
                ...
                <div className="text-(--dark-theme) gap-5 my-auto">
                    ...
                    <p>
                        Velio Bocci è stato un medico-fisiologo  italiano, Prof. ordinario presso l’Università di Siena. È stato pioniere nello studio delle citochine e dell’interferone, e ha concentrato buona parte della sua produzione scientifica sull’ozonoterapia, scrivendo testi e articoli che hanno contribuito a rendere comprensibile questa tecnica. L'importanza dei suoi studi risiede tanto nei risultati e nella produzione scientifica, quanto nel ruolo di “innovatore” che ha attraversato i confini tra la fisiologia, la biochimica e la medicina integrativa.
                    </p>
